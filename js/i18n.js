(() => {
  ...
  "선택한 언어로 계약 내용을 확인할 수 있습니다. 한국어와 영어는 동일한 v1.1 계약 조건을 안내합니다. 동의 시 계약서 버전, 계정, 성명, 확인 항목 및 서버 기준 동의 일시가 기록됩니다.": "You can review the agreement in your selected language. The Korean and English versions describe the same v1.1 terms. When you agree, the agreement version, account, name, confirmation items, and server-recorded consent time are stored.",
  ...
  "v1.1 계약 동의": "v1.1 Agreement Consent",
  ...
  "체험수업은 해당 플랜 및 수업시간의 1회분 금액을 기준으로 하며 NADO 수수료 35%와 Teacher 정산 65% 원칙이 적용되는 것을 확인했습니다.": "I confirm that a trial lesson uses the applicable one-session amount and follows the NADO fee 35% / Teacher payout 65% principle.",
