(() => {
  ...
  "선택한 언어로 계약 내용을 확인할 수 있습니다. 한국어와 영어는 동일한 v1.3 계약 조건을 안내합니다. 동의 시 계약서 버전, 계정, 성명, 확인 항목 및 서버 기준 동의 일시가 기록됩니다.": "You can review the agreement in your selected language. The Korean and English versions describe the same v1.3 terms. When you agree, the agreement version, account, name, confirmation items, and server-recorded consent time are stored.",
  ...
  "v1.3 계약 동의": "v1.3 Agreement Consent",
