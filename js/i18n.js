(() => {
  ...
  "선택": "Optional",
  "본인을 확인할 수 있는 사진을 등록해주세요. JPG, PNG, WEBP 형식으로 최대 5MB까지 업로드할 수 있습니다.": "Upload a clear photo of yourself. JPG, PNG, or WEBP up to 5MB.",
  "등록한 사진은 내 화면과 관리자 선생님 정보 카드에 표시됩니다. JPG, PNG, WEBP / 최대 5MB": "Your photo appears on your page and in the administrator's teacher card. JPG, PNG, or WEBP / up to 5MB.",
  "사진 선택": "Choose Photo",
