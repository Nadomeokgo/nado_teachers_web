...
-- Current agreement v1.1 (bilingual, updated pricing / weekly frequency / trial lessons)
insert into public.teacher_agreement_versions (version, title, agreement_text, content_hash)
values ('v1.1', 'NADO Teacher Service Agreement', $agreement$NADO Teacher Service Agreement v1.1
[Korean]
 본 계약은 NADO(이하 “NADO”)와 NADO Teachers 서비스를 이용하여 학생에게 영어회화 수업을 제공하는 Teacher(이하 “Teacher”) 간의 서비스 이용, 학생 매칭, 수업 운영 및 정산에 관한 사항을 정하는 것을 목적으로 합니다.
 제1조. 서비스 및 계약의 목적
...
[English]
 ...
 I have read and understood the entire NADO Teacher Service Agreement and agree to it.$agreement$, '60e75001ea4df859d0e454e1b13221c0fe7926561d524c79f3da94536a341cd0')
on conflict (version) do nothing;
