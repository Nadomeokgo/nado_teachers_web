(() => {
  ...
  "선택한 언어로 계약 내용을 확인할 수 있습니다. 한국어와 영어는 동일한 v1.4 계약 조건을 안내합니다. 동의 시 계약서 버전, 계정, 성명, 확인 항목 및 서버 기준 동의 일시가 기록됩니다.": "You can review the agreement in your selected language. The Korean and English versions describe the same v1.4 terms. When you agree, the agreement version, account, name, confirmation items, and server-recorded consent time are stored.",
  ...
  "v1.4 계약 동의": "v1.4 Agreement Consent",
  ...
  "체험수업은 학생에게 무료로 제공되고 Economy Plan 체험수업으로 처리되며, 실제 진행된 체험수업 1회당 Teacher 지급액이 20,000원인 것을 확인했습니다.": "I confirm that a trial lesson is free for the student, is handled as an Economy Plan trial lesson, and pays the Teacher KRW 20,000 for each completed trial lesson.",
  ...
  "담당 선생님과 수업 유형을 선택하면 정규 수업 또는 무료 체험수업의 정산액이 자동 계산됩니다.": "Select the Teacher and lesson type to calculate the payout for a regular lesson or free trial lesson.",
  "선택": "Optional",
  ...
  "수업 유형": "Lesson type",
  "정규 수업": "Regular lesson",
  "무료 체험수업": "Free trial lesson",
  "학생 플랜": "Student plan",
